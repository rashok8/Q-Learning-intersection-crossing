...
'''
Perform trials of the simulated vehicle crossing two busy lanes of traffic using
the pre-trained model (trained with qlearn_crossing_2_lanes.py).

usage: test_drive_2_lanes.py [-h] [-s] [-w]
...
from qlearn_crossing_2_lanes import Drive
import custom_plots
