...
'''
Use Q-learning to train a self-driving-vehicle (sdv) to cross two busy lanes of traffic.
...
class Drive(object):
    ...
    def _update(self, action):
        ...
        if np.sum(self.vert_road[self.l2_row-3:self.l2_row])==self.sdv_val*3:
            self.crossed = True            
    ...
    def crossing_opportunity(self):
        ...
        l2_gap_array = self.world[self.l2_row,10:13]
